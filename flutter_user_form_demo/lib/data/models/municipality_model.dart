...
import '../../features/user_form/domain/entities/municipality.dart';

part 'municipality_model.g.dart';

/// Data model for Municipality entity with JSON serialization support
@JsonSerializable()
class MunicipalityModel extends Municipality {
  ...
  /// Converts MunicipalityModel to database map
  ...
  /// Creates a MunicipalityModel from domain entity
